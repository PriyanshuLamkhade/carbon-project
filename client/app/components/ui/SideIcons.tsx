...
export const SideIcons = (props: SideIconProps) => {
  return (
    <div
      className={`rounded-md text-gray-900 py-4 w-full px-2 transition-all duration-400 text-md sm:text-lg md:px-8 cursor-pointer hover:bg-white ${props.className ?? ''}`}
    >
